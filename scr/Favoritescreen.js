    ...
    return (
      ...
      <View style={styles.frame}>
        ...
        <View style={styles.frame2}>
          ...
          <Text style={styles.p11}></Text>
          <Image style={styles.p1} source={require("./icon/rascal2.jpg")}/>
              <View style={styles.word}>
              ...
              <Text style={styles.line1}></Text>
              <Image style={styles.p2} source={require("./icon/3.png")}/>
              </View>
          </View>
          <View style={styles.frame6}>
          <Text style={styles.p11}></Text>
          <Image style={styles.p1} source={require("./icon/rascal3.jpg")}/>
              <View style={styles.word}>
